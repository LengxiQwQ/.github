...
> WinUI 3 桌面应用 · Apple 实况照片的 Windows 管理、修复与转换工具

支持 Google / OPPO / Xiaomi 协议，合并、拆解、修复、封面编辑一站搞定。
...
### ⌨️ [CapsLock IME Switcher](https://github.com/LengxiQwQ/capslock-ime-switcher)

> CapsLock 一键切换中英文输入法 · 快乐编码 🎉

<p>
  <img src="https://img.shields.io/badge/Platform-Windows-0078D7?style=flat-square&logo=windows" />
</p>

### 🎵 [QQ Music Playlist Exporter](https://github.com/LengxiQwQ/qqmusic-playlist-exporter)

> Python 小工具 · 导出 QQ 音乐歌单（TXT / CSV / XLSX / JSON）
